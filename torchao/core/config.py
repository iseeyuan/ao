...
def reconstruct_from_dict(config_dict):
    # Get the class name and configuration parameters
    class_name = config_dict["class_name"]
    config_params = config_dict["config"]
    ...
    # Create an instance of the class from the config parameters
    return config_class.from_dict(config_params)
